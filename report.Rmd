...
caption_4 <- 'The distribution of total variances by Principal components '
caption_5 <- 'The distributions of first two principal components of the data sets.'
caption_8 <- 'Heatmap of gene expression values across different samples'
```
...
plot_pca_variance(variance_tibble,fig.cap = caption_4)
...
make_biplot('proj_metadata.csv', pca_results,fig.cap = caption_5)
...
plot_heatmap(de_intensity, 11, 'RdBu',fig.cap = caption_8)
```
